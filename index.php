...
<body>
    ...
    <main>
            ...
            <div class="px-4 py-5 my-5 text-center">
                ...
                <div class="col-lg-6 mx-auto">
                    ...
                    <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                       ...
                       <a href="components/register.php"> <button type="button" class="btn btn-outline-secondary btn-lg px-4">Register</button></a>
                    </div>
                </div>
            </div>
        </section>
        <div class="container marketing">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <img src="images/amazon.png" width="100" height="100" role="img" aria-label="Placeholder: 100x100"
        ...
        <div class="container marketing">
            ...
            <div class="row featurette">
                ...
                <div class="col-md-5">
                    <a href="components/courses.php"><img src="images/coding.gif" width="330" height="340" role="img" aria-label="Placeholder: 320x320"
            ...
            <div class="row featurette">
                ...
                <div class="col-md-5 order-md-1">
                    <a href="components/courses.php"><img src="images/web.png" width="345" height="340" role="img" aria-label="Placeholder: 320x320"
                        preserveAspectRatio="xMidYMid slice" focusable="false"></a>
            ...
            <div class="row featurette">
                ...
                <div class="col-md-5">
                    <a href="components/courses.php"><img src="images/aptitude.png" width="380" height="310" xmlns="http://www.w3.org/2000/svg"
                        role="img" aria-label="Placeholder: 320x320" preserveAspectRatio="xMidYMid slice"
                        focusable="false"></a>
